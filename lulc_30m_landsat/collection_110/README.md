<div>
    ...
    <h1>Cerrado biome - Collection 11.0</h1>
</div>
...
For detailed information about the classification process and methodology, refer to the Cerrado biome appendix in the [Algorithm Theoretical Basis Document (ATBD)](https://brasil.mapbiomas.org/en/atbd-entenda-cada-etapa/).
...
1. [General map classification](https://github.com/mapbiomas/brazil-cerrado/tree/main/lulc_30m_landsat/collection_110/1-general-map)

2. [Rocky Outcrop classification](https://github.com/mapbiomas/brazil-cerrado/tree/main/lulc_30m_landsat/collection_110/2-rocky-outcrop)

3. [Integration](https://github.com/mapbiomas/brazil-cerrado/tree/main/lulc_30m_landsat/collection_110/3-integration)
